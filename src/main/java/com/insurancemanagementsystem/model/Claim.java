...
public class    Claim {
    ...
    public Claim(int id, Date claimDate, User policyHolder, String cardNumber, Date examDate, Policy policyId, double claimAmount, ClaimStatus status, String receiverBank, String receiverName, String receiverNumber) {
        this.id = id;
